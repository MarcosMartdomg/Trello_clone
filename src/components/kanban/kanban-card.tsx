...
export function KanbanCard({ card, columnTitle, index }: KanbanCardProps) {
        ...
        <>
          <div
            ...
            className={cn(
              ...
              snapshot.isDragging && "shadow-2xl ring-2 ring-primary/20 scale-105 rotate-1 opacity-90 z-50 cursor-grabbing border-primary/30 bg-primary/5"
            )}
